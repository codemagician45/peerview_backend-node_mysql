...
function getUsers (req, res, next) {
  let courseId = req.params.courseId;
   ...
   U.profilePicture as profilePicture, U.socialImage as socialImage FROM peersview.user_course as UC, 
    peersview.user as U WHERE UC.userId = U.id and UC.courseId = ${courseId}`,
