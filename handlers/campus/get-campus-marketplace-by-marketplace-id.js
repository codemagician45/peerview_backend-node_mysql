 ...
 * @returns {rpc} returns the validation error - failed response
 */
function getCampusMarketplaceByMarketplaceId (req, res, next) {// eslint-disable-line id-length
  ...
  .catch(error => {
    ...
    req.log.error({
      err: error.message
    }, `campusMarketplace.findOne Error - get-campus-marketplace-by-marketplace-id`);
  });
}
...
module.exports.logic = getCampusMarketplaceByMarketplaceId;
