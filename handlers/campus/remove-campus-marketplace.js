 ...
 * @description Remove MarketPlace
 */
 ...
 * @returns {rpc} returns the validation error - failed response
 */
function removeCampusMarketplace (req, res, next) {// eslint-disable-line id-length
  let user = req.$scope.user;
  let marketplaceId = req.$params.marketplaceId;

  return req.db.campusMarketplace.destroy({
    where: {
      [req.Op.and]: {
        userId: user.id,
        id: marketplaceId
...
module.exports.logic = removeCampusMarketplace;
